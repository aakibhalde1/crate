...
public abstract class ESIndexLevelReplicationTestCase extends IndexShardTestCase {
    ...
    protected class ReplicationGroup implements AutoCloseable, Iterable<IndexShard> {
        ...
        private BulkItemResponse executeWriteRequest(
            ...
            WriteRequest.RefreshPolicy refreshPolicy) throws Exception {
    ...
    private void executeShardBulkOnPrimary(
        ...
        try (Releasable ignored = permitAcquiredFuture.actionGet()) {
            TransportWriteAction.WritePrimaryResult<ShardUpsertRequest, ShardResponse> result = TransportShardUpsertAction.processRequestItems(
                ...
                null);
            null, ActionTestUtils.assertNoFailureListener(x -> { result.location, logger);listener.onResponse(result); });
        } catch (Exception e) {
            listener.onFailure(e);
        }
    }
     ...
     */
    public BulkShardRequest indexOnPrimary(ShardUpsertRequest request, IndexShard primary) throws Exception {
     ...
     */
    BulkShardRequest deleteOnPrimary(ShardDeleteRequest request, IndexShard primary) throws Exception {
        return executeReplicationRequestOnPrimary(primary, request);
    }
